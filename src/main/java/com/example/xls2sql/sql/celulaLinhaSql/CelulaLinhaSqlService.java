...
public abstract class CelulaLinhaSqlService {
    ...
    /** Verifica se a classe do TipoDadosSql é do tipo {@link com.example.xls2sql.sql.tipoDadosSQL.TipoDadosSqlDateTime TipoDadosSqlDateTime}
     ...
     * @param tipoDadosSql tipoDados da celula vinculada a String
     * @return retorna a String após passar pelos testes de verificação podendo ser modificada ou não conforme o necessário.*/
    public static String formatarCelulaDateTime(String texto, TipoDadosSql tipoDadosSql){

        final String OLD_FORMAT = "dd/MM/yyyy";
        final String NEW_FORMAT = "yyyy/MM/dd";

        if (tipoDadosSql.getClass().getSimpleName().equals("TipoDadosSqlDateTime")){
    ...
    public static boolean checarCelulaAIncluir(ArrayList<String> listaCelulaAdicionar, TipoDados tipoDados) {
        return tipoDados.tipoDadosSql().verificarCelula(listaCelulaAdicionar,tipoDados.numeroElementos());
    }
}